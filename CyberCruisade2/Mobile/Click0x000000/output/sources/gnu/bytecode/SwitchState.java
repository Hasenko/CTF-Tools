    ...
    public boolean insertCase(int value, Label label, CodeAttr code) {
        ...
        if (value < this.minValue) {
            ...
            if (value > copyBefore) {
                ...
                int copyBefore2 = 0;
                while (low2 <= hi) {
                    copyBefore2 = (low2 + hi) >>> 1;
                    if (old_values[copyBefore2] >= value) {
                        hi = copyBefore2 - 1;
                    } else {
                        copyBefore2++;
                        low2 = copyBefore2;
                ...
                if (value == old_values[copyBefore2]) {
                    return false;
                }
                low = copyBefore2;
            }
        }
        int hi2 = this.numCases;
        int copyAfter = hi2 - low;
