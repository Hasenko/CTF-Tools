    ...
    */
            ...
            try {
                ...
                if (Scheme.numGEq.apply2(obj2, printf.Lit1) == Boolean.FALSE) {
                    ...
                    try {
                        ...
                        if (obj3 != Boolean.FALSE) {
                            boolean isString$Eq = strings.isString$Eq(stdio$ClRoundString, "");
                            obj3 = isString$Eq ? LList.list1(Component.TYPEFACE_DEFAULT) : isString$Eq ? Boolean.TRUE : Boolean.FALSE;
                        }
                        if (obj3 != Boolean.FALSE) {
                            return obj3;
                        }
                        ...
                        try {
                            ...
                            throw new WrongType(e, "make-string", 1, min);
                        }
                    } catch (ClassCastException e2) {
                ...
                try {
                    if (numbers.isZero((Number) obj2)) {
                        ...
                        try {
                            ...
                            throw new WrongType(e3, "string-ref", 1, stdio$ClRoundString);
                        }
                    }
                                ...
                                try {
                                    try {
                                        try {
                                            ...
                                            boolean isString$Eq2 = strings.isString$Eq(substring2, "");
                                            return lists.cons(substring, (!isString$Eq2 ? isString$Eq2 : this.staticLink.alternate$Mnform == Boolean.FALSE) ? LList.list2(".", substring2) : LList.Empty);
                                        } catch (ClassCastException e4) {
                                            throw new WrongType(e4, "string-length", 1, stdio$ClRoundString);
                                        }
                                    } catch (ClassCastException e5) {
                                        throw new WrongType(e5, "substring", 2, max);
                                    }
                                } catch (ClassCastException e6) {
                                    throw new WrongType(e6, "substring", 1, stdio$ClRoundString);
                                }
                            } catch (ClassCastException e7) {
                                throw new WrongType(e7, "substring", 3, max);
                            }
                        } catch (ClassCastException e8) {
                                        ...
                                        try {
                                            try {
                                                try {
                                                    ...
                                                    obj5 = Boolean.FALSE;
                                                    LList.chain1(LList.chain1(LList.chain4(list1, str, substring, unicode.isCharUpperCase((Char) obj6) ? "E" : "e", numbers.isNegative(LangObjType.coerceRealNum(obj8)) ? "-" : "+"), Scheme.numLss.apply3(printf.Lit60, obj8, printf.Lit45) != Boolean.FALSE ? Component.TYPEFACE_DEFAULT : ""), numbers.number$To$String(numbers.abs((Number) obj8)));
                                                    obj7 = list1;
                                                    return lists.cons(str3, obj7);
                                                } catch (ClassCastException e5) {
    ...
    public static Object sprintf$V(Object str, Object format, Object[] argsArray) {
        ...
        if (strings.isString(frame13Var.str)) {
            ...
            makeString = frame13Var.str == Boolean.FALSE ? strings.makeString(100) : misc.error$V(Lit68, new Object[]{"first argument not understood", frame13Var.str});
        }
        frame13Var.s = makeString;
