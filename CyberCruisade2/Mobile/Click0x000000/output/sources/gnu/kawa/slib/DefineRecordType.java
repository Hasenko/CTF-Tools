...
public class DefineRecordType extends ModuleBody {
    ...
    static {
        ...
        Lit3 = syntaxRules;
        SimpleSymbol simpleSymbol11 = (SimpleSymbol) new SimpleSymbol("define-record-type").readResolve();
        Lit0 = simpleSymbol11;
        SyntaxRules syntaxRules2 = new SyntaxRules(new Object[]{simpleSymbol11}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007<\f\u000f\r\u0017\u0010\b\b\f\u001f-\f'\f/3 \u0018\b", new Object[0], 7), "\u0001\u0001\u0003\u0001\u0003\u0003\u0002", "\u0011\u0018\u0004Y\u0011\u0018\f\t\u0003\t\u0010\b%\b#¹\u0011\u0018\u0014!\t\u001b\u0018\u001c\u0011\u0018$\u0011\u0018,\b\u0011\u00184\u0011\u0018<\b\u0003ǁ\u0011\u0018\u0014)\t\u000b\b\u0015\u0013\u0011\u0018$\t\u0003\b\u0011\u0018Dy\b\u0011\u0018L\u0011\u0018$\t\u0003\b\u0011\u0018T\b\u0003\u0099\u0011\u0018\u0004\b\u0015\u0011\u0018\\\u0011\u0018L)\u0011\u0018d\b\u0013\b\u0013\u0018l\b%\u0011\u0018t\t\u0003\t#\t+2", new Object[]{simpleSymbol3, (SimpleSymbol) new SimpleSymbol("define-simple-class").readResolve(), simpleSymbol9, PairWithPosition.make(simpleSymbol8, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/DefineRecordType.scm", 122907), simpleSymbol7, (SimpleSymbol) new SimpleSymbol("<boolean>").readResolve(), (SimpleSymbol) new SimpleSymbol(GetNamedPart.INSTANCEOF_METHOD_NAME).readResolve(), simpleSymbol8, (SimpleSymbol) new SimpleSymbol("let").readResolve(), simpleSymbol, (SimpleSymbol) new SimpleSymbol("make").readResolve(), simpleSymbol2, simpleSymbol5, PairWithPosition.make(simpleSymbol, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/DefineRecordType.scm", 143365), simpleSymbol10}, 1)}, 7);
        Lit1 = syntaxRules2;
        DefineRecordType defineRecordType = new DefineRecordType();
        $instance = defineRecordType;
        define$Mnrecord$Mntype = Macro.make(simpleSymbol11, syntaxRules2, defineRecordType);
        $Prvt$$Pcdefine$Mnrecord$Mnfield = Macro.make(simpleSymbol10, syntaxRules, defineRecordType);
