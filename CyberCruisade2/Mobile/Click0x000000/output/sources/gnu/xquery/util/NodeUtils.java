...
public class NodeUtils {
    ...
    public static String name(Object node) {
        Object name;
        return (node == Values.empty || node == null || (name = ((KNode) node).getNodeNameObject()) == null || name == Values.empty) ? "" : name.toString();
    }
