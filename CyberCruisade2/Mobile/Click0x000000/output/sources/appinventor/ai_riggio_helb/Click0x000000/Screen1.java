...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit11 = (SimpleSymbol) new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT).readResolve();
    ...
    public Screen1() {
        ...
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frameVar, 4, Lit32, 8194);
        ...
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frameVar, 8, Lit35, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frameVar, 9, Lit36, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frameVar, 10, Lit37, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frameVar, 11, Lit38, 8194);
        ...
        this.lookup$Mnhandler = new ModuleMethod(frameVar, 17, Lit43, 8194);
