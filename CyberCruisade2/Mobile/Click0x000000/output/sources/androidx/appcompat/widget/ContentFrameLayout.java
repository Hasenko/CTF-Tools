        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (tvw != null && tvw.type != 0) {
                ...
                if (w > 0) {
                    ...
                    widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(w2, widthSize), Declaration.MODULE_REFERENCE);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (tvh != null && tvh.type != 0) {
                ...
                if (h > 0) {
                    ...
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(h2, heightSize), Declaration.MODULE_REFERENCE);
                }
            }
        }
