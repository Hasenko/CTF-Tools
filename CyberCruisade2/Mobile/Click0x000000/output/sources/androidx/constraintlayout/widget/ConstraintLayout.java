                    ...
                    if (params.isHelper) {
                        ...
                        if (child.getVisibility() != 8 && (!optimiseDimensions || !widget.getResolutionWidth().isResolved() || !widget.getResolutionHeight().isResolved())) {
                            ...
                            if (widthSpec2 == -2 && params.horizontalDimensionFixed) {
                                ...
                                widthSpec = View.MeasureSpec.makeMeasureSpec(widthSpec3, Declaration.MODULE_REFERENCE);
                            }
                            if (params.height == -2 && params.verticalDimensionFixed) {
                                ...
                                heightSpec = View.MeasureSpec.makeMeasureSpec(heightSpec2, Declaration.MODULE_REFERENCE);
                            }
            ...
            while (true) {
                ...
                if (child2 == null) {
                    ...
                    if (child2.getMeasuredWidth() == widget2.getWidth() && child2.getMeasuredHeight() == widget2.getHeight()) {
                        ...
                        int widthSpec4 = View.MeasureSpec.makeMeasureSpec(widget2.getWidth(), Declaration.MODULE_REFERENCE);
                        containerWrapWidth = containerWrapWidth2;
                        int heightSpec3 = View.MeasureSpec.makeMeasureSpec(widget2.getHeight(), Declaration.MODULE_REFERENCE);
