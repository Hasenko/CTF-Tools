...
public class AccelerometerSensor extends AndroidNonvisibleComponent implements OnPauseListener, OnResumeListener, SensorComponent, SensorEventListener, Deleteable, RealTimeDataSource<String, Float> {
    ...
    private void startListening() {
        this.androidUIHandler.postDelayed(new Runnable() { // from class: com.google.appinventor.components.runtime.AccelerometerSensor.1
            ...
            public void run() {
                ...
                accelerometerSensor.deviceDefaultOrientation = accelerometerSensor.getDeviceDefaultOrientation();
    ...
    private boolean isShaking(Queue<Float> cache, float currentValue) {
        ...
        switch (AnonymousClass2.$SwitchMap$com$google$appinventor$components$common$Sensitivity[this.sensitivity.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$google$appinventor$components$common$Sensitivity;

        static {
            int[] iArr = new int[Sensitivity.values().length];
            $SwitchMap$com$google$appinventor$components$common$Sensitivity = iArr;
            try {
                iArr[Sensitivity.Weak.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$google$appinventor$components$common$Sensitivity[Sensitivity.Moderate.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$google$appinventor$components$common$Sensitivity[Sensitivity.Strong.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
        }
    }

    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Prior to the release that added this property the AccelerometerSensor component passed through sensor values directly as received from the Android system. However these values do not compensate for tablets that default to Landscape mode, requiring the MIT App Inventor programmer to compensate. However compensating would result in incorrect results in Portrait mode devices such as phones. We now detect Landscape mode tablets and perform the compensation. However if your project is already compensating for the change, you will now get incorrect results. Although our preferred solution is for you to update your project, you can also just set this property to “true” and our compensation code will be deactivated. Note: We recommend that you update your project as we may remove this property in a future release.", userVisible = LinearSystem.FULL_DEBUG)
