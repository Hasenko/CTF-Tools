                            ...
                            public void run() {
                                    ...
                                    try {
                                        ...
                                        if (pendingTag == null) {
                                            ...
                                            try {
                                                ...
                                                cloudDB.jEval(CloudDB.SET_SUB_SCRIPT, CloudDB.SET_SUB_SCRIPT_SHA1, 1, pendingTag, pendingValue, jsonValueList, cloudDB.projectID);
                                                pendingTag = tag2;
                                                pendingValueList = valueList2;
                                                pendingValue = valueList2.getString(0);
                                ...
                                if (pendingTag != null) {
                                    try {
                                        ...
                                        cloudDB2.jEval(CloudDB.SET_SUB_SCRIPT, CloudDB.SET_SUB_SCRIPT_SHA1, 1, pendingTag, pendingValue, jsonValueList2, cloudDB2.projectID);
    ...
    public void RemoveFirstFromList(final String tag) {
        ...
        this.background.submit(new Runnable() { // from class: com.google.appinventor.components.runtime.CloudDB.5
            ...
            public void run() {
                ...
                try {
                    CloudDB cloudDB = CloudDB.this;
                    cloudDB.FirstRemoved(cloudDB.jEval(CloudDB.POP_FIRST_SCRIPT, CloudDB.POP_FIRST_SCRIPT_SHA1, 1, tag, cloudDB.projectID));
                } catch (JedisException e) {
    ...
    public void AppendValueToList(final String tag, Object itemToAdd) {
        ...
        this.background.submit(new Runnable() { // from class: com.google.appinventor.components.runtime.CloudDB.6
            ...
            public void run() {
                ...
                try {
                    CloudDB cloudDB = CloudDB.this;
                    cloudDB.jEval(CloudDB.APPEND_SCRIPT, CloudDB.APPEND_SCRIPT_SHA1, 1, tag, item, cloudDB.projectID);
    ...
    public Jedis getJedis(boolean createNew) {
        ...
        try {
            ...
            if (this.useSSL) {
                ...
                JedisShardInfo jedisinfo = new JedisShardInfo(this.redisServer, this.redisPort, AccessibilityNodeInfoCompat.EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_MAX_LENGTH, true, this.SslSockFactory, (SSLParameters) null, (HostnameVerifier) null);
                jedisinfo.setPassword(jToken);
                Jedis jedis = new Jedis(jedisinfo);
                return jedis;
            }
            JedisShardInfo jedisinfo2 = new JedisShardInfo(this.redisServer, this.redisPort, AccessibilityNodeInfoCompat.EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_MAX_LENGTH);
            jedisinfo2.setPassword(jToken);
            Jedis jedis2 = new Jedis(jedisinfo2);
            return jedis2;
