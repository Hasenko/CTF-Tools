...
public final class Twitter extends AndroidNonvisibleComponent implements ActivityResultListener, Component {
    ...
    @SimpleFunction(description = "Twitter's API no longer supports login via username and password. Use the Authorize call instead.", userVisible = LinearSystem.FULL_DEBUG)
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    handler = Twitter.this.handler;
                    runnable = new Runnable() { // from class: com.google.appinventor.components.runtime.Twitter.6.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    handler = Twitter.this.handler;
                    runnable = new Runnable() { // from class: com.google.appinventor.components.runtime.Twitter.7.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    handler = Twitter.this.handler;
                    runnable = new Runnable() { // from class: com.google.appinventor.components.runtime.Twitter.8.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    handler = Twitter.this.handler;
                    runnable = new Runnable() { // from class: com.google.appinventor.components.runtime.Twitter.12.1
                        @Override // java.lang.Runnable
                        public void run() {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    handler = Twitter.this.handler;
                    runnable = new Runnable() { // from class: com.google.appinventor.components.runtime.Twitter.13.1
                        @Override // java.lang.Runnable
                        public void run() {
