...
public final class ListView extends AndroidViewComponent {
    ...
    public ListView(ComponentContainer container) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(container.$context(), 1, false);
