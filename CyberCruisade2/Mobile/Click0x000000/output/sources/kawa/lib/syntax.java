...
public class syntax extends ModuleBody {
    ...
    static {
        ...
        f8synchronized = Macro.make(simpleSymbol39, new ModuleMethod(syntaxVar, 3, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntaxVar);
        ...
        import$Mnhandle$Mnonly = new ModuleMethod(syntaxVar, 6, simpleSymbol36, 8194);
        import$Mnhandle$Mnexcept = new ModuleMethod(syntaxVar, 7, simpleSymbol35, 8194);
        import$Mnhandle$Mnprefix = new ModuleMethod(syntaxVar, 8, simpleSymbol34, 8194);
        import$Mnhandle$Mnrename = new ModuleMethod(syntaxVar, 9, simpleSymbol33, 8194);
        import$Mnmapper = new ModuleMethod(syntaxVar, 10, simpleSymbol32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f7import = Macro.make(simpleSymbol31, syntaxRules6, syntaxVar);
