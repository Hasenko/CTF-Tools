...
public class Translator extends Compilation {
    ...
    public Expression rewrite_pair(Pair p, boolean function) {
        ...
        if ((func instanceof ReferenceExp) && ((ReferenceExp) func).getBinding() == getNamedPartDecl) {
            ...
            return sym2 != null ? rewrite(sym2, function) : CompileNamedPart.makeExp(part1, part2);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:141:0x01da, code lost:
        ...
        if ((r11 instanceof gnu.bytecode.ArrayClassLoader) == false) goto L138;
     */
    /*
            ...
            if (body instanceof Pair) {
                ...
                if (makeList) {
                    for (int i = first2; i < fsize; i++) {
                        Pair npair = makePair(pair, this.formStack.elementAt(i), LList.Empty);
                        if (lastPair == null) {
                            list = npair;
                        } else {
