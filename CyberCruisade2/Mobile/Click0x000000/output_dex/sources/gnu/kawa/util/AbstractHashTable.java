...
public abstract class AbstractHashTable<Entry extends Map.Entry<K, V>, K, V> extends AbstractMap<K, V> {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [gnu.kawa.util.AbstractHashTable, gnu.kawa.util.AbstractHashTable<Entry extends java.util.Map$Entry<K, V>, K, V>] */
