...
public abstract class Type implements java.lang.reflect.Type {
    ...
    public static synchronized Type make(Class cls) {
        ...
        synchronized (Type.class) {
            ...
            if (classToTypeMap != null && (type2 = classToTypeMap.get(cls)) != null) {
                return type2;
            }
            if (cls.isArray()) {
                ...
                synchronized (hashMap) {
                    ...
                    if (type3 != null && ((cls2 = type3.reflectClass) == cls || cls2 == null)) {
                        type = type3;
                    }
    ...
    static {
        ...
        longType = primType4;
        PrimType primType5 = new PrimType("float", "F", 4, Float.TYPE);
        floatType = primType5;
        PrimType primType6 = new PrimType("double", "D", 8, Double.TYPE);
        doubleType = primType6;
        PrimType primType7 = new PrimType("boolean", "Z", 1, Boolean.TYPE);
        ...
        mapNameToType.put("float", primType5);
