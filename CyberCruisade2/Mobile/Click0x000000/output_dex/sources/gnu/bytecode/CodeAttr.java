...
public class CodeAttr extends Attribute implements AttrContainer {
    ...
    public void emitPushFloat(float x) {
        ...
        if (xi != x || xi < -128 || xi >= 128) {
            ...
            if (xi == 0 && Float.floatToIntBits(x) != 0) {
                reserve(1);
                put1(R$styleable.AppCompatTheme_tooltipForegroundColor);
            }
        } else {
            emitPushInt(xi);
            reserve(1);
        ...
        if (xi == x && xi >= -128 && xi < 128) {
            if (xi == 0 || xi == 1) {
                ...
                if (xi == 0 && Double.doubleToLongBits(x) != 0) {
                    reserve(1);
                    put1(R$styleable.AppCompatTheme_colorError);
                }
            } else {
                emitPushInt(xi);
                reserve(1);
    ...
    */
    ...
    public final void emitMul() {
        emitBinop(R$styleable.AppCompatTheme_buttonStyle);
    }
    ...
    public final void emitShl() {
        emitShift(R$styleable.AppCompatTheme_viewInflaterClass);
    }
