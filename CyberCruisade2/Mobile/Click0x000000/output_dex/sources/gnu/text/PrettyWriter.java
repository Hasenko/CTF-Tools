...
public class PrettyWriter extends Writer {
    ...
    private void pushLogicalBlock(int column, int perLineEnd, int prefixLength, int suffixLength, int sectionStartLine) {
        ...
        iArr2[newLength + BLOCK_SUFFIX_LENGTH] = suffixLength;
        iArr2[newLength + BLOCK_SECTION_START_LINE] = sectionStartLine;
    }
    ...
    public void endLogicalBlock() {
        ...
        if (this.currentBlock < 0) {
            int[] iArr = this.blocks;
            int i = this.blockDepth;
            int suffixLength = iArr[i + BLOCK_SUFFIX_LENGTH];
            int suffixPreviousLength = iArr[i + BLOCK_SECTION_START_LINE + BLOCK_SUFFIX_LENGTH];
    ...
    */
    ...
    void outputLine(int newline) throws IOException {
        ...
        if (!isLiteral) {
            ...
            iArr2[i3 + BLOCK_SECTION_START_LINE] = lineNumber;
        }
    }
