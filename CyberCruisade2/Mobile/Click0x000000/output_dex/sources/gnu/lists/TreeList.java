    ...
    public int stringValue(boolean z, int i, StringBuffer stringBuffer) {
        ...
        if (c >= OBJECT_REF_SHORT && c <= 61439) {
            ...
            switch (c) {
                ...
                case 61710:
                default:
                    throw new Error("unimplemented: " + Integer.toHexString(c) + " at:" + i3);
                case BEGIN_ELEMENT_LONG /* 61704 */:
                    r5 = i3 + 2;
                    int intN = getIntN(i3);
                    i3 = intN + (intN < 0 ? this.data.length : i3 - 1) + 7;
                    obj = null;
                    break;
                case BEGIN_ATTRIBUTE_LONG /* 61705 */:
                    r5 = z ? 0 : i3 + 4;
                    int intN2 = getIntN(i3 + 2);
                    if (intN2 < 0) {
                        i3 = this.data.length + 1;
                    }
                    i3 += intN2;
                    obj = null;
                    break;
                ...
                case END_ENTITY /* 61715 */:
                    return -1;
                case 61711:
                    ((TreeList) ((AbstractSequence) this.objects[getIntN(i3)])).stringValue(z, getIntN(i3 + 2) >> 1, stringBuffer);
                    i3 += 4;
                    obj = null;
                    break;
                case BEGIN_DOCUMENT /* 61712 */:
                ...
                case COMMENT /* 61719 */:
                    ...
                    if (!z || c == CDATA_SECTION) {
                        stringBuffer.append(this.data, i4, intN3);
                    }
                    return i4 + intN3;
                case JOINER /* 61718 */:
                    obj = null;
        ...
        if (r5 > 0) {
            do {
                r5 = stringValue(true, r5, stringBuffer);
            } while (r5 >= 0);
        }
        return i3;
    }
