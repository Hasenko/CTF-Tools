...
public abstract class RatNum extends RealNum {
    ...
    public static RatNum valueOf(BigDecimal value) {
        ...
        switch (scale > 0 ? scale : -scale) {
            ...
            case 4:
                ...
                break;
            case 5:
                scaleVal = IntNum.make(Form.MAX_PERMISSION_NONCE);
                break;
            case 6:
        ...
        return scale > 0 ? divide(v, (RatNum) scaleVal) : times(v, (RatNum) scaleVal);
    }
    ...
    private static RealNum simplest_rational2(RealNum x, RealNum y) {
        ...
        RealNum n2 = IntNum.one();
        return (RealNum) fx.add(n2, 1);
    }
}
