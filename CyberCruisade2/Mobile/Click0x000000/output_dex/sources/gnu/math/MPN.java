...
class MPN {
    ...
    public static int sub_n(int[] dest, int[] X, int[] Y, int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int y2 = y + cy;
            int i2 = 0;
            int cy2 = (y2 ^ RtlSpacingHelper.UNDEFINED) < (cy ^ RtlSpacingHelper.UNDEFINED) ? 1 : 0;
            int y3 = x - y2;
            if ((y3 ^ RtlSpacingHelper.UNDEFINED) > (Integer.MIN_VALUE ^ x)) {
                i2 = 1;
            }
            cy = cy2 + i2;
            dest[i] = y3;
    ...
    public static int submul_1(int[] dest, int offset, int[] x, int len, int y) {
        ...
        while (true) {
            ...
            int carry2 = ((prod_low ^ RtlSpacingHelper.UNDEFINED) < (carry ^ RtlSpacingHelper.UNDEFINED) ? 1 : 0) + prod_high;
            int carry3 = offset + j;
            int x_j = dest[carry3];
            int prod_low2 = x_j - prod_low;
            if ((prod_low2 ^ RtlSpacingHelper.UNDEFINED) > (Integer.MIN_VALUE ^ x_j)) {
                carry2++;
            }
    ...
    public static int cmp(int[] x, int[] y, int size) {
        ...
        return (x_word ^ RtlSpacingHelper.UNDEFINED) > (Integer.MIN_VALUE ^ y_word) ? 1 : -1;
    }
