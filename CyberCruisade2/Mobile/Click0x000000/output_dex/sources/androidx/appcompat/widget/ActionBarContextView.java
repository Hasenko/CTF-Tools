...
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childSpecHeight = View.MeasureSpec.makeMeasureSpec(height, RtlSpacingHelper.UNDEFINED);
        View view = this.mClose;
        if (view != null) {
        ...
        if (view2 != null) {
            ...
            int customWidthMode = lp2.width != -2 ? Declaration.MODULE_REFERENCE : RtlSpacingHelper.UNDEFINED;
            int customWidth = lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth;
            if (lp2.height == -2) {
                customHeightMode = RtlSpacingHelper.UNDEFINED;
            }
