...
public final class AppCompatDrawableManager {
    ...
    private Drawable tintDrawable(Context context, int resId, boolean failIfNotKnown, Drawable drawable) {
        ...
        if (resId == R$drawable.abc_seekbar_track_material) {
            ...
            Drawable findDrawableByLayerId = ld.findDrawableByLayerId(R.id.background);
            ...
            setPorterDuffColorFilter(ld.findDrawableByLayerId(R.id.secondaryProgress), ThemeUtils.getThemeAttrColor(context, R$attr.colorControlNormal), mode);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(R.id.progress), ThemeUtils.getThemeAttrColor(context, R$attr.colorControlActivated), mode);
            return drawable;
        }
        if (resId == R$drawable.abc_ratingbar_material || resId == R$drawable.abc_ratingbar_indicator_material || resId == R$drawable.abc_ratingbar_small_material) {
            ...
            Drawable findDrawableByLayerId2 = ld2.findDrawableByLayerId(R.id.background);
            ...
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(R.id.secondaryProgress), ThemeUtils.getThemeAttrColor(context, R$attr.colorControlActivated), mode2);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(R.id.progress), ThemeUtils.getThemeAttrColor(context, R$attr.colorControlActivated), mode2);
            return drawable;
        }
