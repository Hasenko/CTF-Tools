...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int contentInsetStart = a.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetStart, RtlSpacingHelper.UNDEFINED);
        int contentInsetEnd = a.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetEnd, RtlSpacingHelper.UNDEFINED);
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetStartWithNavigation, RtlSpacingHelper.UNDEFINED);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(R$styleable.Toolbar_contentInsetEndWithActions, RtlSpacingHelper.UNDEFINED);
