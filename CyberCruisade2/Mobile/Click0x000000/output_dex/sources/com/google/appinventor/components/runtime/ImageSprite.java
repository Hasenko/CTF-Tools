...
public class ImageSprite extends Sprite {
    ...
    public void onDraw(android.graphics.Canvas canvas) {
        if (this.drawable != null && this.visible) {
            int xinit = (int) (Math.round(this.xLeft) * this.form.deviceDensity());
            int yinit = (int) (Math.round(this.yTop) * this.form.deviceDensity());
    ...
    protected List<Vector2D> getNormalAxes() {
    ...
    protected List<Vector2D> getExtremityVectors() {
