...
public final class Translator extends AndroidNonvisibleComponent {
    ...
    public void performRequest(String languageToTranslateTo, String textToTranslate) {
        ...
        try {
            ...
            try {
                TranslatorToken.request request = TranslatorToken.request.newBuilder().setToken(token).setTotranslate(textToTranslate).setSourcelanguage(srcLanguage).setTargetlanguage(targetLanguage).m861build();
