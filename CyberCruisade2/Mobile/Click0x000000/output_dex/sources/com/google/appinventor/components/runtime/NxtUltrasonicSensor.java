...
public class NxtUltrasonicSensor extends LegoMindstormsNxtSensor implements Deleteable {
            ...
            public void run() {
                ...
                if (NxtUltrasonicSensor.this.bluetooth != null && NxtUltrasonicSensor.this.bluetooth.IsConnected()) {
                    ...
                    if (sensorValue.valid) {
                        if (sensorValue.value.intValue() < NxtUltrasonicSensor.this.bottomOfRange) {
                            currentState = State.BELOW_RANGE;
                        } else if (sensorValue.value.intValue() > NxtUltrasonicSensor.this.topOfRange) {
    ...
    @DesignerProperty(defaultValue = DEFAULT_SENSOR_PORT, editorType = "lego_nxt_sensor_port")
