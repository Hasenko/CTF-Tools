...
public class Map extends MapFeatureContainerBase implements MapFactory.MapEventListener {
    ...
    @SimpleProperty
    @DesignerProperty(defaultValue = Component.TYPEFACE_SANSSERIF, editorType = "map_type")
    ...
    public void LocationSensor(LocationSensor sensor) {
        ...
        LocationSensor locationSensor = this.sensor;
        if (locationSensor != null) {
            locationSensor.removeListener(listener);
        }
        this.sensor = sensor;
        if (sensor != null) {
    ...
    @DesignerProperty(defaultValue = Component.TYPEFACE_SANSSERIF, editorType = "map_unit_system")
    ...
    @Override // com.google.appinventor.components.runtime.MapFeatureContainerBase
    void addFeature(MapFactory.MapLineString lineString) {
