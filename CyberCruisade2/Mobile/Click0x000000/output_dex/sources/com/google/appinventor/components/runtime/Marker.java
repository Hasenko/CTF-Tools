...
public class Marker extends MapFeatureBaseWithFill implements MapFactory.MapMarker {
    ...
    @DesignerProperty(defaultValue = Component.TYPEFACE_DEFAULT, editorType = "latitude")
    ...
    @Override // com.google.appinventor.components.runtime.util.MapFactory.MapMarker
    @SimpleProperty(category = PropertyCategory.BEHAVIOR)
    @DesignerProperty(defaultValue = Component.TYPEFACE_DEFAULT, editorType = "longitude")
    ...
    @Override // com.google.appinventor.components.runtime.util.MapFactory.MapMarker
    @SimpleProperty(category = PropertyCategory.APPEARANCE)
    @DesignerProperty(defaultValue = Component.TYPEFACE_MONOSPACE, editorType = "horizontal_alignment")
    ...
    @Override // com.google.appinventor.components.runtime.util.MapFactory.MapMarker
    @SimpleProperty(category = PropertyCategory.APPEARANCE)
    @DesignerProperty(defaultValue = Component.TYPEFACE_MONOSPACE, editorType = "vertical_alignment")
    ...
    public int Width() {
        ...
        if (i < -1000) {
            double d = -i;
            Double.isNaN(d);
            double width = this.map.getView().getWidth();
            Double.isNaN(width);
            return (int) (((d - 1000.0d) / 100.0d) * width);
        }
        return i;
    }
    ...
    public int Height() {
        ...
        if (i < -1000) {
            double d = -i;
            Double.isNaN(d);
            double height = this.map.getView().getHeight();
            Double.isNaN(height);
            return (int) (((d - 1000.0d) / 100.0d) * height);
        }
        return i;
    }
