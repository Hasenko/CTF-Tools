...
public final class ErrorMessages {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(ERROR_BLUETOOTH_COULD_NOT_FIT_NUMBER_IN_BYTE), "Could not fit \"%s\" into 1 byte.");
        hashMap.put(512, "Could not fit \"%s\" into %s bytes.");
        hashMap.put(Integer.valueOf(ERROR_BLUETOOTH_COULD_NOT_DECODE_ELEMENT), "Could not decode element %s as an integer.");
        ...
        hashMap.put(Integer.valueOf(ERROR_UNCAUGHT_EXCEPTION_IN_THREAD), "Uncaught exception on %s thread: %s");
