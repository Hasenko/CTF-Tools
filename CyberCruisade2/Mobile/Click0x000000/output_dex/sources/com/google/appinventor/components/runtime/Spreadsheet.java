...
public class Spreadsheet extends AndroidNonvisibleComponent implements Component, ObservableDataSource<YailList, Future<YailList>> {
    ...
    @DesignerProperty(defaultValue = FusiontablesControl.APP_NAME, editorType = "string")
            ...
            public void run() {
                try {
                    ...
                    if (values != null && !values.isEmpty()) {
                        ...
                        Iterator<Object> it2 = values.get(0).iterator();
                        while (it2.hasNext()) {
                            Object obj = it2.next();
        ...
        AsynchUtil.runAsynchronously(new Runnable() { // from class: com.google.appinventor.components.runtime.Spreadsheet.6
            ...
            public void run() {
                try {
                    ...
                    int maxRow = values2 == null ? 1 : values2.size() + 1;
                        ...
                        if (values != null && !values.isEmpty()) {
                            ...
                            for (List<Object> row : values) {
                                ...
                                while (it.hasNext()) {
                                    ...
                                    Object[] objArr = new Object[1];
                                    objArr[0] = cellValue == null ? "" : cellValue;
