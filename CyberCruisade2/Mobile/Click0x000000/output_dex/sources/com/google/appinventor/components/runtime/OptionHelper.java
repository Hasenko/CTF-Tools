...
public class OptionHelper {
    ...
    public static <T> Object optionListFromValue(Object c, String func, T value) {
        ...
        Options annotation = (Options) calledFunc.getAnnotation(Options.class);
        if (annotation == null) {
            return value;
        }
    ...
    private static Method getMethod(Object c, String func) {
        ...
        java.util.Map<String, Method> methodMap = map.get(componentKey);
        if (methodMap == null) {
            methodMap = populateMap(componentClass);
            map.put(componentKey, methodMap);
        }
