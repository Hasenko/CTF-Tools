...
public class syntax extends ModuleBody {
    ...
    static {
        ...
        SimpleSymbol simpleSymbol16 = (SimpleSymbol) new SimpleSymbol(LispLanguage.quote_sym).readResolve();
        Lit108 = simpleSymbol16;
        SimpleSymbol simpleSymbol17 = (SimpleSymbol) new SimpleSymbol("wt").readResolve();
        Lit107 = simpleSymbol17;
        SimpleSymbol simpleSymbol18 = (SimpleSymbol) new SimpleSymbol("as").readResolve();
        Lit106 = simpleSymbol18;
        SimpleSymbol simpleSymbol19 = (SimpleSymbol) new SimpleSymbol("arg").readResolve();
        Lit105 = simpleSymbol19;
        SimpleSymbol simpleSymbol20 = (SimpleSymbol) new SimpleSymbol(LispLanguage.quasiquote_sym).readResolve();
        Lit104 = simpleSymbol20;
        SimpleSymbol simpleSymbol21 = (SimpleSymbol) new SimpleSymbol("gnu.mapping.LocationProc").readResolve();
        Lit103 = simpleSymbol21;
        SimpleSymbol simpleSymbol22 = (SimpleSymbol) new SimpleSymbol("$lookup$").readResolve();
        Lit102 = simpleSymbol22;
        SimpleSymbol simpleSymbol23 = (SimpleSymbol) new SimpleSymbol("define-alias-parameter").readResolve();
        Lit100 = simpleSymbol23;
        SyntaxRules syntaxRules = new SyntaxRules(new Object[]{simpleSymbol23}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\f\u0017\b", new Object[0], 3), "\u0001\u0001\u0001", "\u0011\u0018\u0004¹\u0011\u0018\f\t\u0003\u0011\u0018\u0014\u0011\u0018\u001c\b\u0011\u0018$)\u0011\u0018,\b\u0003\b\u0013\b\u0011\u00184\t\u0003\b\u0011\u0018<\u0011\u0018D\b\u0011\u0018L9\u0011\u0018T\t\u000b\u0018\\\b\u0011\u0018d\u0011\u0018l\b\u0011\u0018ty\b\u0011\u0018|\b\u0011\u0018\u0084\u0011\u0018d\t\u0003\u0018\u008cA\u0011\u0018\u0094\u0011\u0018\u009c\b\u000b\u0018¤", new Object[]{simpleSymbol14, (SimpleSymbol) new SimpleSymbol("define-constant").readResolve(), (SimpleSymbol) new SimpleSymbol("::").readResolve(), (SimpleSymbol) new SimpleSymbol("<gnu.mapping.LocationProc>").readResolve(), PairWithPosition.make(simpleSymbol22, Pair.make(simpleSymbol21, Pair.make(Pair.make(simpleSymbol20, Pair.make((SimpleSymbol) new SimpleSymbol("makeNamed").readResolve(), LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1069060), simpleSymbol16, PairWithPosition.make(simpleSymbol22, Pair.make(simpleSymbol21, Pair.make(Pair.make(simpleSymbol20, Pair.make((SimpleSymbol) new SimpleSymbol("pushConverter").readResolve(), LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1073161), simpleSymbol15, PairWithPosition.make(simpleSymbol19, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1081354), (SimpleSymbol) new SimpleSymbol("try-catch").readResolve(), simpleSymbol18, PairWithPosition.make(simpleSymbol19, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1089550), (SimpleSymbol) new SimpleSymbol("ex").readResolve(), (SimpleSymbol) new SimpleSymbol("<java.lang.ClassCastException>").readResolve(), simpleSymbol9, simpleSymbol17, PairWithPosition.make(simpleSymbol22, Pair.make((SimpleSymbol) new SimpleSymbol("gnu.mapping.WrongType").readResolve(), Pair.make(Pair.make(simpleSymbol20, Pair.make((SimpleSymbol) new SimpleSymbol("make").readResolve(), LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1097748), PairWithPosition.make(PairWithPosition.make(simpleSymbol18, PairWithPosition.make((SimpleSymbol) new SimpleSymbol("<int>").readResolve(), PairWithPosition.make(IntNum.make(1), LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1101846), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1101840), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1101836), PairWithPosition.make(simpleSymbol19, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1101849), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1101836), (SimpleSymbol) new SimpleSymbol("set!").readResolve(), PairWithPosition.make((SimpleSymbol) new SimpleSymbol("field").readResolve(), PairWithPosition.make(simpleSymbol17, PairWithPosition.make(PairWithPosition.make(simpleSymbol16, PairWithPosition.make((SimpleSymbol) new SimpleSymbol("expectedType").readResolve(), LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1105941), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1105941), LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1105940), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1105937), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1105930), PairWithPosition.make(PairWithPosition.make((SimpleSymbol) new SimpleSymbol("primitive-throw").readResolve(), PairWithPosition.make(simpleSymbol17, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1110037), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1110020), LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 1110020)}, 0)}, 3);
        Lit101 = syntaxRules;
        SimpleSymbol simpleSymbol24 = (SimpleSymbol) new SimpleSymbol("receive").readResolve();
        Lit98 = simpleSymbol24;
        SyntaxRules syntaxRules2 = new SyntaxRules(new Object[]{simpleSymbol24}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\r\u0017\u0010\b\b", new Object[0], 3), "\u0001\u0001\u0003", "\u0011\u0018\u00049\u0011\u0018\f\t\u0010\b\u000b\b\u0011\u0018\f\t\u0003\b\u0015\u0013", new Object[]{simpleSymbol8, simpleSymbol15}, 1)}, 3);
        Lit99 = syntaxRules2;
        SimpleSymbol simpleSymbol25 = (SimpleSymbol) new SimpleSymbol("cond-expand").readResolve();
        Lit91 = simpleSymbol25;
        Lit97 = new SyntaxTemplate("\u0001\u0001\u0000\u0000", "\u0011\u0018\u0004\u001a", new Object[]{simpleSymbol25}, 0);
        Lit96 = new SyntaxTemplate("\u0001\u0001\u0000\u0000", "\u0011\u0018\u0004\u0012", new Object[]{simpleSymbol14}, 0);
        Lit95 = new SyntaxTemplate("\u0001\u0001\u0000\u0000", "\u000b", new Object[0], 0);
        Lit94 = new SyntaxPattern("\f\u0007\u001c\f\u000f\u0013\u001b", new Object[0], 4);
        SimpleSymbol simpleSymbol26 = (SimpleSymbol) new SimpleSymbol("%cond-expand").readResolve();
        Lit93 = simpleSymbol26;
        SyntaxRules syntaxRules3 = new SyntaxRules(new Object[]{simpleSymbol25, simpleSymbol12, simpleSymbol11, simpleSymbol10, simpleSymbol13}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\b", new Object[0], 0), "", "\u0018\u0004", new Object[]{PairWithPosition.make((SimpleSymbol) new SimpleSymbol("%syntax-error").readResolve(), PairWithPosition.make("Unfulfilled cond-expand", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 802851), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 802836)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018<\f\u0002\r\u0007\u0000\b\b\b", new Object[]{simpleSymbol13}, 1), "\u0003", "\u0011\u0018\u0004\b\u0005\u0003", new Object[]{simpleSymbol14}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018L\u001c\f\u0002\b\r\u0007\u0000\b\b\r\u000f\b\b\b", new Object[]{simpleSymbol12}, 2), "\u0003\u0003", "\u0011\u0018\u0004\b\u0005\u0003", new Object[]{simpleSymbol14}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018|L\f\u0002\f\u0007\r\u000f\b\b\b\r\u0017\u0010\b\b\r\u001f\u0018\b\b", new Object[]{simpleSymbol12}, 4), "\u0001\u0003\u0003\u0003", "\u0011\u0018\u0004¡\t\u0003\b\u0011\u0018\u0004Q1\u0011\u0018\f\b\r\u000b\b\u0015\u0013\b\u001d\u001b\b\u001d\u001b", new Object[]{simpleSymbol25, simpleSymbol12}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018L\u001c\f\u0002\b\r\u0007\u0000\b\b\r\u000f\b\b\b", new Object[]{simpleSymbol11}, 2), "\u0003\u0003", "\u0011\u0018\u0004\b\r\u000b", new Object[]{simpleSymbol25}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018|L\f\u0002\f\u0007\r\u000f\b\b\b\r\u0017\u0010\b\b\r\u001f\u0018\b\b", new Object[]{simpleSymbol11}, 4), "\u0001\u0003\u0003\u0003", "\u0011\u0018\u0004I\t\u0003\b\u0011\u0018\f\b\u0015\u0013\b\u0011\u0018\u0014\b\u0011\u0018\u0004Q1\u0011\u0018\u001c\b\r\u000b\b\u0015\u0013\b\u001d\u001b", new Object[]{simpleSymbol25, simpleSymbol14, simpleSymbol13, simpleSymbol11}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\\,\f\u0002\f\u0007\b\r\u000f\b\b\b\r\u0017\u0010\b\b", new Object[]{simpleSymbol10}, 3), "\u0001\u0003\u0003", "\u0011\u0018\u0004I\t\u0003\b\u0011\u0018\u0004\b\u0015\u0013\b\u0011\u0018\f\b\r\u000b", new Object[]{simpleSymbol25, simpleSymbol13}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\u000b\u0013", new Object[0], 3), "\u0001\u0000\u0000", "\u0011\u0018\u0004\u0019\t\u0003\n\u0012", new Object[]{simpleSymbol26}, 0)}, 4);
        Lit92 = syntaxRules3;
        ...
        Lit83 = new SyntaxTemplate("\u0001\u0000", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol22, Pair.make((SimpleSymbol) new SimpleSymbol("gnu.expr.GenericProc").readResolve(), Pair.make(Pair.make(simpleSymbol20, Pair.make((SimpleSymbol) new SimpleSymbol("makeWithoutSorting").readResolve(), LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 651273)}, 0);
        Lit82 = new SyntaxPattern("\f\u0007\u000b", new Object[0], 2);
        SimpleSymbol simpleSymbol27 = (SimpleSymbol) new SimpleSymbol("case-lambda").readResolve();
        Lit81 = simpleSymbol27;
        SimpleSymbol simpleSymbol28 = (SimpleSymbol) new SimpleSymbol("let*-values").readResolve();
        Lit79 = simpleSymbol28;
        SyntaxPattern syntaxPattern = new SyntaxPattern("\f\u0018<\f\u0007\r\u000f\b\b\b\f\u0017\r\u001f\u0018\b\b", new Object[0], 4);
        SimpleSymbol simpleSymbol29 = (SimpleSymbol) new SimpleSymbol("let-values").readResolve();
        Lit77 = simpleSymbol29;
        SyntaxRules syntaxRules4 = new SyntaxRules(new Object[]{simpleSymbol28}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\b\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\r\u000b", new Object[]{simpleSymbol14}, 1), new SyntaxRule(syntaxPattern, "\u0001\u0003\u0001\u0003", "\u0011\u0018\u0004\u0011\b\u0003\b\u0011\u0018\f\u0019\b\r\u000b\t\u0013\b\u001d\u001b", new Object[]{simpleSymbol29, simpleSymbol28}, 1)}, 4);
        Lit80 = syntaxRules4;
        SyntaxRules syntaxRules5 = new SyntaxRules(new Object[]{simpleSymbol29}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018,\r\u0007\u0000\b\b\f\u000f\r\u0017\u0010\b\b", new Object[0], 3), "\u0003\u0001\u0003", "\u0011\u0018\u0004\u0011\u0018\f\u0019\b\u0005\u0003\t\u0010\b\u0011\u0018\u0014\t\u000b\b\u0015\u0013", new Object[]{simpleSymbol29, "bind", simpleSymbol14}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\f\b\f\u0007\f\u000f\b", new Object[]{"bind"}, 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\b\u000b", new Object[]{simpleSymbol9}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\\,\f\u0007\f\u000f\b\r\u0017\u0010\b\b\f\u001f\f'\b", new Object[]{"bind"}, 5), "\u0001\u0001\u0003\u0001\u0001", "\u0011\u0018\u0004\u0011\u0018\f\t\u0003\t\u000b\t\u0010\u0019\b\u0015\u0013\t\u001b\b#", new Object[]{simpleSymbol29, "mktmp"}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\f\b\f\u0007\f\u000f\f\u0017\f\u001f\f'\b", new Object[]{"mktmp"}, 5), "\u0001\u0001\u0001\u0001\u0001", "\u0011\u0018\u00049\u0011\u0018\f\t\u0010\b\u0003\b\u0011\u0018\f\t\u000b\b\u0011\u0018\u0014\u0011\u0018\u001c\t\u0013\t\u001b\b#", new Object[]{simpleSymbol8, simpleSymbol15, simpleSymbol29, "bind"}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\u001c\f\u0007\u000b\f\u0017,\r\u001f\u0018\b\b\f',\r/(\b\b\f7\b", new Object[]{"mktmp"}, 7), "\u0001\u0000\u0001\u0003\u0001\u0003\u0001", "\u0011\u0018\u0004\u0011\u0018\f\t\n\t\u0013)\u0011\u001d\u001b\u0018\u0014\t#A\u0011-+\b\t\u0003\u0018\u001c\b3", new Object[]{simpleSymbol29, "mktmp", PairWithPosition.make(simpleSymbol7, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 569387), PairWithPosition.make(simpleSymbol7, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 569414)}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\f\u0007\f\u000f,\r\u0017\u0010\b\b\f\u001f,\r' \b\b\f/\b", new Object[]{"mktmp"}, 6), "\u0001\u0001\u0003\u0001\u0003\u0001", "\u0011\u0018\u00049\u0011\u0018\f\t\u0010\b\u000b\b\u0011\u0018\f)\u0011\u0015\u0013\u0018\u0014\b\u0011\u0018\u001c\u0011\u0018$\t\u001bA\u0011%#\b\t\u0003\u0018,\b+", new Object[]{simpleSymbol8, simpleSymbol15, simpleSymbol7, simpleSymbol29, "bind", PairWithPosition.make(simpleSymbol7, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 593973)}, 1)}, 7);
        Lit78 = syntaxRules5;
        Lit76 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0010", new Object[0], 0);
        Lit75 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0013", new Object[0], 0);
        Lit74 = new SyntaxTemplate("\u0001\u0001\u0001", "\b\u000b", new Object[0], 0);
        Lit73 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol22, Pair.make(simpleSymbol6, Pair.make(Pair.make(simpleSymbol20, Pair.make(simpleSymbol5, LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 466951)}, 0);
        ...
        Lit68 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol22, Pair.make(simpleSymbol6, Pair.make(Pair.make(simpleSymbol20, Pair.make(simpleSymbol5, LList.Empty)), LList.Empty)), "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 458759)}, 0);
        ...
        Lit65 = new SyntaxPattern("\f\u0007,\f\u0002\f\u000f\u0013\f\u001f\b", new Object[]{simpleSymbol4}, 4);
        Lit64 = new SyntaxTemplate("\u0001\u0001\u0001\u0001", "\u0010", new Object[0], 0);
        Lit63 = new SyntaxTemplate("\u0001\u0001\u0001\u0001", "\u001b", new Object[0], 0);
        Lit62 = new SyntaxTemplate("\u0001\u0001\u0001\u0001", "\u0013", new Object[0], 0);
        SimpleSymbol simpleSymbol30 = (SimpleSymbol) new SimpleSymbol("%import").readResolve();
        Lit38 = simpleSymbol30;
        Lit61 = new SyntaxTemplate("\u0001\u0001\u0001\u0001", "\u0011\u0018\u0004\b\u000b", new Object[]{simpleSymbol30}, 0);
        Lit60 = new SyntaxPattern("\f\u0007<\f\u0002\f\u000f\f\u0017\b\f\u001f\b", new Object[]{simpleSymbol4}, 4);
        ...
        Lit55 = new SyntaxTemplate("\u0001\u0001\u0000\u0001", "\u0011\u0018\u0004\b\u000b", new Object[]{simpleSymbol30}, 0);
        ...
        Lit48 = new SyntaxTemplate("\u0001\u0001\u0000\u0001", "\u0011\u0018\u0004\b\u000b", new Object[]{simpleSymbol30}, 0);
        ...
        Lit41 = new SyntaxTemplate("\u0001\u0001\u0000\u0001", "\u0011\u0018\u0004\b\u000b", new Object[]{simpleSymbol30}, 0);
        ...
        SimpleSymbol simpleSymbol31 = (SimpleSymbol) new SimpleSymbol("import").readResolve();
        Lit36 = simpleSymbol31;
        SyntaxRules syntaxRules6 = new SyntaxRules(new Object[]{simpleSymbol31}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\r\u0007\u0000\b\b", new Object[0], 1), "\u0003", "\u0011\u0018\u0004\b\u0005\u0011\u0018\f\t\u0003\u0018\u0014", new Object[]{simpleSymbol14, simpleSymbol30, PairWithPosition.make(LList.Empty, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 376866)}, 1)}, 1);
        Lit37 = syntaxRules6;
        SimpleSymbol simpleSymbol32 = (SimpleSymbol) new SimpleSymbol("import-mapper").readResolve();
        Lit35 = simpleSymbol32;
        SimpleSymbol simpleSymbol33 = (SimpleSymbol) new SimpleSymbol("import-handle-rename").readResolve();
        Lit34 = simpleSymbol33;
        SimpleSymbol simpleSymbol34 = (SimpleSymbol) new SimpleSymbol("import-handle-prefix").readResolve();
        Lit33 = simpleSymbol34;
        SimpleSymbol simpleSymbol35 = (SimpleSymbol) new SimpleSymbol("import-handle-except").readResolve();
        Lit32 = simpleSymbol35;
        SimpleSymbol simpleSymbol36 = (SimpleSymbol) new SimpleSymbol("import-handle-only").readResolve();
        Lit31 = simpleSymbol36;
        SimpleSymbol simpleSymbol37 = (SimpleSymbol) new SimpleSymbol("identifier-pair-list?").readResolve();
        Lit30 = simpleSymbol37;
        SimpleSymbol simpleSymbol38 = (SimpleSymbol) new SimpleSymbol("identifier-list?").readResolve();
        Lit29 = simpleSymbol38;
        Lit28 = new SyntaxTemplate("\u0001\u0001\u0000", "\u0012", new Object[0], 0);
        Lit27 = new SyntaxTemplate("\u0001\u0001\u0000", "\u000b", new Object[0], 0);
        Lit26 = new SyntaxPattern("\f\u0007\f\u000f\u0013", new Object[0], 3);
        SimpleSymbol simpleSymbol39 = (SimpleSymbol) new SimpleSymbol("synchronized").readResolve();
        ...
        SimpleSymbol simpleSymbol40 = (SimpleSymbol) new SimpleSymbol("try-finally").readResolve();
        Lit21 = simpleSymbol40;
        SimpleSymbol simpleSymbol41 = (SimpleSymbol) new SimpleSymbol("when").readResolve();
        Lit17 = simpleSymbol41;
        SyntaxRules syntaxRules7 = new SyntaxRules(new Object[]{simpleSymbol41}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u0004)\u0011\u0018\f\b\u0003\b\u0011\u0018\u0014\b\r\u000b", new Object[]{simpleSymbol3, simpleSymbol10, simpleSymbol14}, 1)}, 2);
        Lit20 = syntaxRules7;
        SimpleSymbol simpleSymbol42 = (SimpleSymbol) new SimpleSymbol("unless").readResolve();
        Lit19 = simpleSymbol42;
        SyntaxRules syntaxRules8 = new SyntaxRules(new Object[]{simpleSymbol41}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\b\r\u000b", new Object[]{simpleSymbol3, simpleSymbol14}, 1)}, 2);
        Lit18 = syntaxRules8;
        SimpleSymbol simpleSymbol43 = (SimpleSymbol) new SimpleSymbol("define-syntax-case").readResolve();
        Lit15 = simpleSymbol43;
        SyntaxRules syntaxRules9 = new SyntaxRules(new Object[]{simpleSymbol43}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\u0013", new Object[0], 3), "\u0001\u0001\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\u0011\u0018\u0014\b\u0011\u0018\u001c\u0011\u0018$\t\u000b\u0012", new Object[]{(SimpleSymbol) new SimpleSymbol("define-syntax").readResolve(), simpleSymbol15, PairWithPosition.make(simpleSymbol2, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 90129), (SimpleSymbol) new SimpleSymbol("syntax-case").readResolve(), simpleSymbol2}, 0)}, 3);
        Lit16 = syntaxRules9;
        SimpleSymbol simpleSymbol44 = (SimpleSymbol) new SimpleSymbol("define-macro").readResolve();
        Lit13 = simpleSymbol44;
        SyntaxRules syntaxRules10 = new SyntaxRules(new Object[]{simpleSymbol44}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\u000b\u0013", new Object[0], 3), "\u0001\u0000\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\n\u0012", new Object[]{simpleSymbol, simpleSymbol15}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\b", new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\b\u000b", new Object[]{simpleSymbol}, 0)}, 3);
        Lit14 = syntaxRules10;
        SimpleSymbol simpleSymbol45 = (SimpleSymbol) new SimpleSymbol("defmacro").readResolve();
        Lit11 = simpleSymbol45;
        SyntaxRules syntaxRules11 = new SyntaxRules(new Object[]{simpleSymbol45}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\u0013", new Object[0], 3), "\u0001\u0001\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\u000b\u0012", new Object[]{simpleSymbol, simpleSymbol15}, 0)}, 3);
        Lit12 = syntaxRules11;
        ...
        defmacro = Macro.make(simpleSymbol45, syntaxRules11, syntaxVar);
        define$Mnmacro = Macro.make(simpleSymbol44, syntaxRules10, syntaxVar);
        define$Mnsyntax$Mncase = Macro.make(simpleSymbol43, syntaxRules9, syntaxVar);
        when = Macro.make(simpleSymbol41, syntaxRules8, syntaxVar);
        unless = Macro.make(simpleSymbol42, syntaxRules7, syntaxVar);
        try$Mnfinally = Macro.make(simpleSymbol40, new ModuleMethod(syntaxVar, 2, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntaxVar);
        f5synchronized = Macro.make(simpleSymbol39, new ModuleMethod(syntaxVar, 3, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntaxVar);
        identifier$Mnlist$Qu = new ModuleMethod(syntaxVar, 4, simpleSymbol38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        identifier$Mnpair$Mnlist$Qu = new ModuleMethod(syntaxVar, 5, simpleSymbol37, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        import$Mnhandle$Mnonly = new ModuleMethod(syntaxVar, 6, simpleSymbol36, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        import$Mnhandle$Mnexcept = new ModuleMethod(syntaxVar, 7, simpleSymbol35, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        import$Mnhandle$Mnprefix = new ModuleMethod(syntaxVar, 8, simpleSymbol34, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        import$Mnhandle$Mnrename = new ModuleMethod(syntaxVar, 9, simpleSymbol33, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        import$Mnmapper = new ModuleMethod(syntaxVar, 10, simpleSymbol32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f4import = Macro.make(simpleSymbol31, syntaxRules6, syntaxVar);
        $Pcimport = Macro.make(simpleSymbol30, new ModuleMethod(syntaxVar, 11, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntaxVar);
        let$Mnvalues = Macro.make(simpleSymbol29, syntaxRules5, syntaxVar);
        let$St$Mnvalues = Macro.make(simpleSymbol28, syntaxRules4, syntaxVar);
        case$Mnlambda = Macro.make(simpleSymbol27, new ModuleMethod(syntaxVar, 12, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntaxVar);
        cond$Mnexpand = Macro.make(simpleSymbol25, syntaxRules3, syntaxVar);
        ...
        $Pccond$Mnexpand = Macro.make(simpleSymbol26, moduleMethod, syntaxVar);
        receive = Macro.make(simpleSymbol24, syntaxRules2, syntaxVar);
        define$Mnalias$Mnparameter = Macro.make(simpleSymbol23, syntaxRules, syntaxVar);
        syntaxVar.run();
    }
    ...
    */
    public static boolean isIdentifierPairList(java.lang.Object r4) {
        ...
        L11:
            ...
            kawa.lang.SyntaxPattern r3 = kawa.lib.syntax.Lit5
            boolean r3 = r3.match(r4, r0, r2)
            if (r3 == 0) goto L4c
            kawa.lang.TemplateScope r4 = kawa.lang.TemplateScope.make()
            kawa.lang.SyntaxTemplate r3 = kawa.lib.syntax.Lit6
            java.lang.Object r4 = r3.execute(r0, r4)
            boolean r4 = kawa.lib.std_syntax.isIdentifier(r4)
            if (r4 == 0) goto L4a
            kawa.lang.TemplateScope r4 = kawa.lang.TemplateScope.make()
            kawa.lang.SyntaxTemplate r3 = kawa.lib.syntax.Lit7
            java.lang.Object r4 = r3.execute(r0, r4)
            boolean r4 = kawa.lib.std_syntax.isIdentifier(r4)
            if (r4 == 0) goto L4a
            kawa.lang.TemplateScope r4 = kawa.lang.TemplateScope.make()
            kawa.lang.SyntaxTemplate r3 = kawa.lib.syntax.Lit8
            java.lang.Object r4 = r3.execute(r0, r4)
            goto L11
        L4a:
            r1 = r4
            goto L54
        L4c:
            kawa.lang.SyntaxPattern r3 = kawa.lib.syntax.Lit9
            boolean r3 = r3.match(r4, r0, r2)
            if (r3 == 0) goto L55
        L54:
            goto L6a
        L55:
            kawa.lang.SyntaxPattern r3 = kawa.lib.syntax.Lit10
    ...
    static Object lambda4(Object form) {
        ...
        if (Lit39.match(form, allocVars, 0)) {
            if (!isIdentifierPairList(Lit40.execute(allocVars, TemplateScope.make()))) {
                return prim_syntax.syntaxError(Lit45.execute(allocVars, TemplateScope.make()), "invalid 'rename' clause in import" instanceof Object[] ? (Object[]) "invalid 'rename' clause in import" : new Object[]{"invalid 'rename' clause in import"});
            }
        ...
        if (Lit46.match(form, allocVars, 0)) {
            if (!isIdentifierList(Lit47.execute(allocVars, TemplateScope.make()))) {
                return prim_syntax.syntaxError(Lit52.execute(allocVars, TemplateScope.make()), "invalid 'only' identifier list" instanceof Object[] ? (Object[]) "invalid 'only' identifier list" : new Object[]{"invalid 'only' identifier list"});
            }
        ...
        if (Lit53.match(form, allocVars, 0)) {
            if (!isIdentifierList(Lit54.execute(allocVars, TemplateScope.make()))) {
                return prim_syntax.syntaxError(Lit59.execute(allocVars, TemplateScope.make()), "invalid 'except' identifier list" instanceof Object[] ? (Object[]) "invalid 'except' identifier list" : new Object[]{"invalid 'except' identifier list"});
            }
        ...
        if (Lit60.match(form, allocVars, 0)) {
        ...
        if (Lit65.match(form, allocVars, 0)) {
            return prim_syntax.syntaxError(Lit66.execute(allocVars, TemplateScope.make()), "invalid prefix clause in import" instanceof Object[] ? (Object[]) "invalid prefix clause in import" : new Object[]{"invalid prefix clause in import"});
        }
        if (Lit67.match(form, allocVars, 0)) {
        ...
        if (!Lit72.match(form, allocVars, 0)) {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda6loop(Object clauses) {
            ...
            if (syntax.Lit89.match(clauses, allocVars, 0)) {
                return LList.list1(prim_syntax.syntaxError(syntax.Lit90.execute(allocVars, this.$unnamed$0), "invalid case-lambda clause" instanceof Object[] ? (Object[]) "invalid case-lambda clause" : new Object[]{"invalid case-lambda clause"}));
            }
