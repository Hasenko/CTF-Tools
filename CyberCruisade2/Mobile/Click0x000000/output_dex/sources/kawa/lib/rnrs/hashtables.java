...
public class hashtables extends ModuleBody {
    ...
    static {
        ...
        hashtable$Mndelete$Ex = new ModuleMethod(hashtablesVar, 13, simpleSymbol14, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        hashtable$Mncontains$Qu = new ModuleMethod(hashtablesVar, 14, simpleSymbol13, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
