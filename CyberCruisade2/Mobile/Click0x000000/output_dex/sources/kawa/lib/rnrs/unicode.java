...
public class unicode extends ModuleBody {
    ...
    static {
        ...
        char$Mnci$Eq$Qu = new ModuleMethod(unicodeVar, 11, simpleSymbol19, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        char$Mnci$Ls$Qu = new ModuleMethod(unicodeVar, 12, simpleSymbol18, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        char$Mnci$Gr$Qu = new ModuleMethod(unicodeVar, 13, simpleSymbol17, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        char$Mnci$Ls$Eq$Qu = new ModuleMethod(unicodeVar, 14, simpleSymbol16, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        char$Mnci$Gr$Eq$Qu = new ModuleMethod(unicodeVar, 15, simpleSymbol15, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        string$Mnci$Eq$Qu = new ModuleMethod(unicodeVar, 21, simpleSymbol9, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Mnci$Ls$Qu = new ModuleMethod(unicodeVar, 22, simpleSymbol8, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Mnci$Gr$Qu = new ModuleMethod(unicodeVar, 23, simpleSymbol7, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Mnci$Ls$Eq$Qu = new ModuleMethod(unicodeVar, 24, simpleSymbol6, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Mnci$Gr$Eq$Qu = new ModuleMethod(unicodeVar, 25, simpleSymbol5, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
