...
public class system extends ModuleBody {
    ...
    static {
        ...
        $instance = systemVar;
        make$Mnprocess = new ModuleMethod(systemVar, 1, simpleSymbol10, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        compile$Mnfile = new ModuleMethod(systemVar, 8, simpleSymbol3, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        f6catch = new ModuleMethod(systemVar, 9, simpleSymbol2, 12291);
    ...
    /* renamed from: catch, reason: not valid java name */
    public static Object m1146catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m1146catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
