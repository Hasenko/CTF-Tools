...
public class files extends ModuleBody {
    ...
    static {
        ...
        rename$Mnfile = new ModuleMethod(filesVar, 22, simpleSymbol9, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        copy$Mnfile = new ModuleMethod(filesVar, 23, simpleSymbol8, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        resolve$Mnuri = new ModuleMethod(filesVar, 29, simpleSymbol2, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
