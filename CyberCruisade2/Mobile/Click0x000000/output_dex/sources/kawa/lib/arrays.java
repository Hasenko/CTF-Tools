...
public class arrays extends ModuleBody {
    ...
    static {
        ...
        array$Mnstart = new ModuleMethod(arraysVar, 7, simpleSymbol3, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        array$Mnend = new ModuleMethod(arraysVar, 8, simpleSymbol2, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
