...
public class vectors extends ModuleBody {
    ...
    static {
        ...
        vector$Mnref$Fn1 = new ModuleMethod(vectorsVar, 6, simpleSymbol4, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        vector$Mnfill$Ex = new ModuleMethod(vectorsVar, 9, simpleSymbol, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        vectorsVar.run();
    }
