...
public class misc extends ModuleBody {
    ...
    static {
        ...
        ModuleMethod moduleMethod = new ModuleMethod(miscVar, 6, null, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        environment$Mnbound$Qu = new ModuleMethod(miscVar, 17, simpleSymbol13, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
