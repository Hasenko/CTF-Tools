...
public class strings extends ModuleBody {
    ...
    static {
        ...
        string$Mnref = new ModuleMethod(stringsVar, 6, simpleSymbol18, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Mnset$Ex = new ModuleMethod(stringsVar, 7, simpleSymbol17, 12291);
        string$Eq$Qu = new ModuleMethod(stringsVar, 8, simpleSymbol16, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Ls$Qu = new ModuleMethod(stringsVar, 9, simpleSymbol15, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Gr$Qu = new ModuleMethod(stringsVar, 10, simpleSymbol14, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Ls$Eq$Qu = new ModuleMethod(stringsVar, 11, simpleSymbol13, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        string$Gr$Eq$Qu = new ModuleMethod(stringsVar, 12, simpleSymbol12, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        string$Mnfill$Ex = new ModuleMethod(stringsVar, 17, simpleSymbol7, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
