...
public class numbers extends ModuleBody {
    ...
    static {
        ...
        div$Mnand$Mnmod = new ModuleMethod(numbersVar, 15, simpleSymbol47, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        div0$Mnand$Mnmod0 = new ModuleMethod(numbersVar, 16, simpleSymbol46, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        rationalize = new ModuleMethod(numbersVar, 25, simpleSymbol37, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        ModuleMethod moduleMethod = new ModuleMethod(numbersVar, 33, null, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        make$Mnrectangular = new ModuleMethod(numbersVar, 37, simpleSymbol29, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        make$Mnpolar = new ModuleMethod(numbersVar, 38, simpleSymbol28, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        bitwise$Mnbit$Mnset$Qu = new ModuleMethod(numbersVar, 48, simpleSymbol18, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        logtest = new ModuleMethod(numbersVar, 53, simpleSymbol13, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        make$Mnquantity = new ModuleMethod(numbersVar, 66, simpleSymbol2, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
