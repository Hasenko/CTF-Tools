...
public class uniform extends ModuleBody {
    ...
    static {
        ...
        s8vector$Mnref = new ModuleMethod(uniformVar, 6, simpleSymbol76, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        u8vector$Mnref = new ModuleMethod(uniformVar, 15, simpleSymbol68, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        s16vector$Mnref = new ModuleMethod(uniformVar, 24, simpleSymbol60, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        u16vector$Mnref = new ModuleMethod(uniformVar, 33, simpleSymbol52, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        s32vector$Mnref = new ModuleMethod(uniformVar, 42, simpleSymbol44, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        u32vector$Mnref = new ModuleMethod(uniformVar, 51, simpleSymbol36, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        s64vector$Mnref = new ModuleMethod(uniformVar, 60, simpleSymbol28, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        u64vector$Mnref = new ModuleMethod(uniformVar, 69, simpleSymbol20, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        f32vector$Mnref = new ModuleMethod(uniformVar, 78, simpleSymbol12, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        f64vector$Mnref = new ModuleMethod(uniformVar, 87, simpleSymbol4, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
