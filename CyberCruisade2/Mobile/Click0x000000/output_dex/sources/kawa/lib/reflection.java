...
public class reflection extends ModuleBody {
    ...
    static {
        ...
        make$Mnrecord$Mntype = new ModuleMethod(reflectionVar, 3, simpleSymbol20, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        record$Mnconstructor = new ModuleMethod(reflectionVar, 4, simpleSymbol19, 8193);
        record$Mnaccessor = new ModuleMethod(reflectionVar, 6, simpleSymbol18, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        record$Mnmodifier = new ModuleMethod(reflectionVar, 7, simpleSymbol17, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        subtype$Qu = new ModuleMethod(reflectionVar, 13, simpleSymbol3, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        reflectionVar.run();
    }
