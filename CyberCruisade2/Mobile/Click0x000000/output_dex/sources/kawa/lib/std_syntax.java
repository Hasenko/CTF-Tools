...
public class std_syntax extends ModuleBody {
    ...
    static {
        ...
        f2case = Macro.make(simpleSymbol44, syntaxRules17, std_syntaxVar);
        ...
        f3do = Macro.make(simpleSymbol30, syntaxRules5, std_syntaxVar);
        ...
        datum$Mn$Grsyntax$Mnobject = new ModuleMethod(std_syntaxVar, 4, simpleSymbol26, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        free$Mnidentifier$Eq$Qu = new ModuleMethod(std_syntaxVar, 7, simpleSymbol23, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
