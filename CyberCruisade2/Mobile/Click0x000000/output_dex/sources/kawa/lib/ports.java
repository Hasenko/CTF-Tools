...
public class ports extends ModuleBody {
    ...
    static {
        ...
        call$Mnwith$Mninput$Mnfile = new ModuleMethod(portsVar, 3, simpleSymbol34, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        call$Mnwith$Mnoutput$Mnfile = new ModuleMethod(portsVar, 4, simpleSymbol33, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        with$Mninput$Mnfrom$Mnfile = new ModuleMethod(portsVar, 5, simpleSymbol32, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        with$Mnoutput$Mnto$Mnfile = new ModuleMethod(portsVar, 6, simpleSymbol31, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        call$Mnwith$Mninput$Mnstring = new ModuleMethod(portsVar, 17, simpleSymbol24, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        set$Mnport$Mnline$Ex = new ModuleMethod(portsVar, 31, simpleSymbol15, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        port$Mnline$Fn4 = new ModuleMethod(portsVar, 32, simpleSymbol14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mninput$Mnport$Mnline$Mnnumber$Ex = new ModuleMethod(portsVar, 33, simpleSymbol13, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
        ...
        set$Mninput$Mnport$Mnprompter$Ex = new ModuleMethod(portsVar, 38, simpleSymbol8, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
