...
if __name__ == "__main__":
    test_list = list(range(0, 25))
    """
    print(test_list)

    print('clock right')
    print_matrix(create_spiral_matrix(test_list, True, 'right'))

    print('clock left')
    print_matrix(create_spiral_matrix(test_list, True, 'left'))

    # print('clock up')
    # print_matrix(create_spiral_matrix(test_list, True, 'up'))

    # print('clock down')
    # print_matrix(create_spiral_matrix(test_list, True, 'down'))

    print()
    print('-----------------------')
    print()

    print('counter-clock right')
    print_matrix(create_spiral_matrix(test_list, False, 'right'))

    print('counter-clock left')
    print_matrix(create_spiral_matrix(test_list, False, 'left'))

    # print('counter-clock up')
    # print_matrix(create_spiral_matrix(test_list, False, 'up'))

    # print('counter-clock down')
    # print_matrix(create_spiral_matrix(test_list, False, 'down'))
    """

    print("==================================")
    print('clock right')
    matrix = create_spiral_matrix(test_list, True, 'right')
    print_matrix(matrix)
    print("------------")
    print('unspiraled 1')
    print(unspiral_matrix(matrix, True, 'right'))
    print("------------")
    print('unspiraled 2')
    print(unspiral_matrix(matrix, True, 'left'))
    print("------------")
    print('unspiraled 3')
    print(unspiral_matrix(matrix, True, 'up'))
    print("------------")
    print('unspiraled 4')
    print(unspiral_matrix(matrix, True, 'down'))
    print("------------")
    print('unspiraled 5')
    print(unspiral_matrix(matrix, False, 'right'))
    print("------------")
    print('unspiraled 6')
    print(unspiral_matrix(matrix, False, 'left'))
    print("------------")
    print('unspiraled 7')
    print(unspiral_matrix(matrix, False, 'up'))
    print("------------")
    print('unspiraled 8')
    print(unspiral_matrix(matrix, False, 'down'))