...
.method private static parseKeyAttribute(Landroidx/constraintlayout/core/parser/CLObject;Landroidx/constraintlayout/core/state/Transition;)V
    ...
    .line 327
    .local v8, "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    if-eqz v8, :cond_4
    ...
    invoke-direct {v9, v5, v0}, Landroidx/constraintlayout/core/parser/CLParsingException;-><init>(Ljava/lang/String;Landroidx/constraintlayout/core/parser/CLElement;)V

    throw v9

    .line 327
    .end local v18    # "scaleTypes":[Z
    ...
    .line 332
    .end local v5    # "scaleTypes":[Z
    .restart local v18    # "scaleTypes":[Z
    :goto_2
    if-eqz v8, :cond_7
    ...
    .line 334
    invoke-virtual {v8, v5}, Landroidx/constraintlayout/core/parser/CLArray;->getFloat(I)F
    ...
    invoke-interface {v10, v9}, Landroidx/constraintlayout/core/state/CorePixelDp;->toPixels(F)F
    ...
    invoke-virtual {v10, v15, v9}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(IF)V
    ...
    .end local v8    # "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    .end local v9    # "i":I
    ...
    .local v23, "attrNames":[Ljava/lang/String;
    array-length v6, v11
    ...
    .local v26, "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    ...
    .end local v9    # "n":I
    .local v27, "n":I
    invoke-direct {v7, v14, v9, v8}, Landroidx/constraintlayout/core/motion/CustomVariable;-><init>(Ljava/lang/String;IF)V
    ...
    .end local v25    # "attrIds":[I
    .end local v26    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    .end local v27    # "n":I
    ...
    .end local v8    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    .end local v9    # "n":I
    .restart local v25    # "attrIds":[I
    .restart local v26    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    ...
    .local v28, "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    long-to-int v15, v6
    ...
    .local v29, "color":J
    invoke-direct {v9, v14, v6, v15}, Landroidx/constraintlayout/core/motion/CustomVariable;-><init>(Ljava/lang/String;II)V
    ...
    .line 374
    .end local v28    # "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    ...
    .end local v6    # "color":J
    .end local v15    # "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    .restart local v28    # "arrayValues":Landroidx/constraintlayout/core/parser/CLArray;
    :goto_9
    add-int/lit8 v5, v5, 0x1
    ...
    .line 383
    .end local v23    # "attrNames":[Ljava/lang/String;
    .end local v25    # "attrIds":[I
    .end local v26    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    .end local v27    # "n":I
    .local v6, "attrNames":[Ljava/lang/String;
    ...
    .end local v8    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    .end local v9    # "n":I
    .restart local v23    # "attrNames":[Ljava/lang/String;
    .restart local v25    # "attrIds":[I
    .restart local v26    # "customObj":Landroidx/constraintlayout/core/parser/CLObject;
    .restart local v27    # "n":I
    invoke-virtual {v13}, Landroidx/constraintlayout/core/parser/CLKey;->getValue()Landroidx/constraintlayout/core/parser/CLElement;
    ...
    invoke-direct {v9, v14, v15, v6}, Landroidx/constraintlayout/core/motion/CustomVariable;-><init>(Ljava/lang/String;IF)V
    ...
    .line 413
    invoke-static {v5, v13}, Landroidx/constraintlayout/core/state/TransitionParser;->map(Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v9, v14, v13}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(II)V
    ...
    invoke-virtual {v9, v13, v4}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->addIfNotNull(ILjava/lang/String;)V
...
.method private static parseKeyCycle(Landroidx/constraintlayout/core/parser/CLObject;Landroidx/constraintlayout/core/state/Transition;)V
    ...
    invoke-interface {v6, v9}, Landroidx/constraintlayout/core/state/CorePixelDp;->toPixels(F)F
    ...
    invoke-virtual {v6, v15, v9}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(IF)V
    ...
    invoke-virtual {v15, v2, v4}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->addIfNotNull(ILjava/lang/String;)V
    ...
    invoke-virtual {v15, v2, v6}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(ILjava/lang/String;)V
    ...
    invoke-virtual {v15, v2, v8}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(ILjava/lang/String;)V
    ...
    invoke-virtual {v15, v2, v9}, Landroidx/constraintlayout/core/motion/utils/TypedBundle;->add(ILjava/lang/String;)V
