...
###
def decode(pgn_input_file_path: str, output_file_path: str):
    start_time = time()
    ...
    with open(pgn_input_file_path, "r") as file:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python script.py <input_file_path.pgn> <output_file_path>")
    else:
        pgn_input_file_path = sys.argv[1]
        output_file_path = sys.argv[2]
        decode(pgn_input_file_path, output_file_path)